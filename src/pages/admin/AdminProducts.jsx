            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  min="0"
                  step="0.01"
                  className="w-full border border-gray-200 rounded-lg pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-100 transition-all"
                  value={data.price ?? ''}
