    ...
    <>
      ...
      <nav className="bg-primary">
        <div className="max-w-[1200px] mx-auto flex items-center">
          ...
          <Link
            to="/admin"
            className="ml-auto px-4 py-2.5 text-white text-sm font-medium bg-red-600 hover:bg-red-700 transition-colors"
          >
            เข้าสู่ระบบ
          </Link>
        ...
        {mobileOpen && (
          <div className="md:hidden bg-primary border-t border-blue-700 pb-2">
            <Link
              ...
              className="block px-4 py-2 text-white text-sm border-b border-white/10"
            >
              หน้าหลัก
            </Link>
            <p className="px-4 py-1 text-white/50 text-xs">ข้อมูลทั่วไป</p>
            <Link
              to="/general-info"
              onClick={() => setMobileOpen(false)}
              className="block px-6 py-2 text-white/85 text-sm border-b border-white/10"
            >
              › ข้อมูลทั่วไป
            </Link>
            <Link
