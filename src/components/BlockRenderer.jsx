...
function WordBlock({ data, preview }) {
  ...
  return (
    <div className="bg-white border-b border-gray-100">
      ...
      {preview ? (
        <div className="mx-3 my-2 rounded-lg border border-dashed border-blue-200 bg-blue-50 flex items-center justify-center gap-3" style={{ height: 80 }}>
          <WordFileIcon size={24} />
          <div>
